	...
	<?php if ($this->session->userdata('role') != '1') { ?>
		...
		<?php if ($this->session->userdata('role') != '1') { ?>
			...
			<script>
				...
				// Array of fixed colors for each label
				var fixedColors = [
					'#FF5733', '#33FFB3', '#33A4FF', '#FF33E6',
					'#FFCC33', '#337BFF'
				...
				var doughnutChart = new Chart(ctx, {
					...
					data: {
						...
						datasets: [{
							data: jumlahUnit,
							backgroundColor: fixedColors, // Use the fixedColors array here
							borderWidth: 1
						}]
					},
					options: {
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="small-box bg-info">
							<div class="inner">
								<h3><?php echo $users['role_count']; ?> </h3>
								<p>Jumlah Users</p>
							</div>
							<div class="icon">
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="small-box bg-primary">
							<div class="inner">
								<h3><?php echo $timesheet_deleted['role_count']; ?><sup style="font-size: 20px"></sup></h3>
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="small-box bg-success">
							<div class="inner">
								<h3><?php echo $karyawan_deleted['role_count']; ?></h3>
								<p>Karyawan Deleted</p>
							</div>
							<div class="icon">
								<i class="bi bi-people-fill"></i>
							</div>
							<a href="<?php echo site_url('deleted/karyawan') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="small-box bg-warning">
							<div class="inner">
								<h3><?php echo $unit_deleted['role_count']; ?><sup style="font-size: 20px"></sup></h3>
								<p>Unit Deleted</p>
							</div>
							<div class="icon">
								<i class="bi bi-list-task"></i>
